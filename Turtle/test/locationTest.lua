...
function _testCreateHelper(arg)
  ...
  if arg then
    if arg.attitude then
      ...
      globalMockOrientationData.instances[#globalMockOrientationData.instances].expected.getState = { att:clone() }
      ...
      globalMockOrientationData.instances[#globalMockOrientationData.instances].expected.getState = { { } }
    end
...
function _testHelper(func, expected)
  ...
  instanceMockData.expected.getState = { true }
